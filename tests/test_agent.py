...
class AgentTest(unittest.TestCase):
    ...
    def test_web_ui_exposes_agent_tool_trace(self) -> None:
        ...
        self.assertIn("trace render failed", APP_JS)
        self.assertIn("Failed to render saved agent conversation", APP_JS)
        self.assertIn('class="agent-trace"', APP_JS)
        self.assertIn('class="trace-event trace-${escapeHtml(event.type || "event")}"', APP_JS)
